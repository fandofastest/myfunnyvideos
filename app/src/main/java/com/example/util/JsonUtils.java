...
import static com.videos.funny.MainActivity.TAG_BANNER;
import static com.videos.funny.MainActivity.TAG_BANNERMAINRS;
...
public class JsonUtils {
    ...
    //facebookads
    private static LinearLayout bannerAdContainer;
    private static com.facebook.ads.AdView bannerAdView;
...
//        boolean isTablet = getResources().getBoolean(R.bool.is_tablet);
                bannerAdView = new com.facebook.ads.AdView(activity, prf.getString(TAG_BANNERMAINRS), com.facebook.ads.AdSize.BANNER_HEIGHT_50);
