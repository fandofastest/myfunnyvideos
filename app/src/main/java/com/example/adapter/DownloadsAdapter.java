...
import com.videos.funny.PlayerActivity;
...
//        holder.text.setText(filename[position]);
        ...
        Glide.with(mContext).load(Uri.fromFile(new File(filepath[position]))).placeholder(R.mipmap.app_icon).centerCrop().into(holder.image);
