...
import com.example.item.Subtitle;
...
public class PlayerViewModel extends BaseObservable implements ExoPlayer.EventListener {
    ...
    public PlayerViewModel(Activity activity) {
        mActivity = activity;
    }
