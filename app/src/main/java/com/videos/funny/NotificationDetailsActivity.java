...
import static com.example.util.Constant.TAG_NOTIFICATION_ID;
import static com.example.util.Constant.TAG_NOTIFICATION_IMAGE;
import static com.example.util.Constant.TAG_NOTIFICATION_LOG_ENTDATE;
import static com.example.util.Constant.TAG_NOTIFICATION_MSG;
import static com.example.util.Constant.TAG_NOTIFICATION_TITLE;
import static com.example.util.Constant.TAG_NOTIFICATION_URL;
import static com.example.util.Constant.TAG_NOTIFICATION_VIDEOID;
...
public class NotificationDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (image.length()>5) {
            Glide.with(NotificationDetailsActivity.this).load(Constant.IMAGE_PATH_URL + image).placeholder(R.drawable.loading).centerCrop().into(topImage);
        }
